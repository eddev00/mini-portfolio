  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="text-white text-[15px]">
        &nbsp;&nbsp; My name is Mohamed Baarar, i’m someone who is passionate
        about creating and building things, I find great joy in exploring the
        vast and dynamic world of technology. From designing and developing
        websites and apps, to video games development and exploring the the vast
        world of data, I am constantly seeking out new challenges and
